...
- **CityWalk** — same global parchment as other rooms (`vintageScreenBackground`), **MY TOWN** header, map with `pastelYellow` road wash overlay and invisible circular tap targets on buildings; Bakery opens the A1 dialogue scene.
...
*Last updated: 2026-05-02 (Removed unused SPM snapshot stub and empty tests; CityWalk header cleanup)*
