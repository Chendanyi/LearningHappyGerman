...
- **CityWalk** — **MY TOWN** map with invisible tap targets; each building opens **`ScenarioDialogueView`**, a multi-turn A1/A2 German script (`ScenarioCatalog`) with topic vocabulary, clerk role label, and a hero **SF Symbol** or optional **asset** (`ScenarioConfig.backgroundImageName`).
...
*Last updated: 2026-05-02 (CityWalk: `CityScenarioEngine` + 12 `ScenarioConfig` dialogues, `ScenarioDialogueView`)*
